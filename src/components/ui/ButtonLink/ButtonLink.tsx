...
export const ButtonLink: React.FC<ButtonLinkProps> = props => {
  ...
  const btnClasses = cn(
    {
      'flex h-11 w-full shrink-0 items-center justify-center rounded-[24px] px-6 py-2 text-base/[1.4] font-normal hover:font-semibold focus:font-semibold tracking-[-.02em] text-white transition-all md:max-w-[336px] xl:h-12  xl:max-w-[282px] xl:text-lg/[1.4] 2xl:max-w-[253px] 2xl:text-xl':
        styleType !== 'unstyled',
